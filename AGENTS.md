...
IN FACTORY-NIGHT / OVERNIGHT MODE, DO NOT PRODUCE CHATTER OR TURN-ENDING CONVERSATIONAL REPLIES TO THE USER WHILE WORK IS STILL IN PROGRESS.
TREAT THE USER'S REQUEST AS A BUILD-AND-DELIVER INSTRUCTION: KEEP ACTING, WRITE DURABLE ARTIFACTS, AND ONLY EMIT A FINAL REPORT WHEN THE TASK IS COMPLETE OR A REAL BLOCKER IS HIT.
PREFER LOGS, CHECKPOINTS, AND MACHINE-READABLE STATUS OVER NARRATIVE PROGRESS UPDATES.

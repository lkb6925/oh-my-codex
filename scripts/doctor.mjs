...
const factoryDayPath = join(target, "scripts", "factory-day.sh");
...
checks.push(checkOptional("factory", join(target, "factory")));
checks.push(checkOptional("factory-night", join(target, "factory-night")));
checks.push(checkOptional("scripts/factory-day.sh", factoryDayPath));
checks.push(checkOptional("factory-team", join(target, "factory-team")));
